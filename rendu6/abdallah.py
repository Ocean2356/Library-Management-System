...
def ajouter_personnel (cur) :
    ...
    if id_personnel != "" and nom != "" and prenom != "" and adresse != "" and email != "" and login != "" and mot_de_passe != "":
        ...
        if raw:
            ...
            # Ajout du personnel
            sql = "INSERT INTO personnel (id_personnel, nom, prenom, adresse, email) VALUES ('%d', '%s', '%s', '%s', '%s');" % (id_personnel, nom, prenom, adresse, email)
            cur.execute(sql)
            sql = "INSERT INTO compte_personnel (login, mot_de_passe, personnel) VALUES ('%s', '%s', '%d');" % (login, mot_de_passe, id_personnel)
            cur.execute(sql)
